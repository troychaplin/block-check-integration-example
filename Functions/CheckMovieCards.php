	...
	private function register_movie_card_checks( $registry ) {
		$registry->register_check_with_plugin_detection(
			...
			array(
				...
				'description' => __( 'Movie title', 'multi-block-checks-example' ),
				'type'        => 'settings',
		...
		$registry->register_check_with_plugin_detection(
			...
			array(
				...
				'description' => __( 'Movie link', 'multi-block-checks-example' ),
				'type'        => 'settings',
				'category'    => 'accessibility',
			)
		);
		...
		$registry->register_check_with_plugin_detection(
			...
			array(
				'error_msg'   => __( 'Date is required for card blocks.', 'multi-block-checks-example' ),
				'warning_msg' => __( 'Consider adding a date for better credibility.', 'multi-block-checks-example' ),
				'description' => __( 'Movie release date', 'multi-block-checks-example' ),
				'type'        => 'settings',
				'category'    => 'accessibility',
			)
		);
		...
		$registry->register_check_with_plugin_detection(
			...
			array(
				...
				'description' => __( 'Movie description', 'multi-block-checks-example' ),
				'type'        => 'settings',
				'category'    => 'validation',
			)
		);
